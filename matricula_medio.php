...
<form class="row g-3">
  ...
  <div class="col-12">
  <label for="idc" class="form-label">Curso</label>
    <select nome="c" id="idc" class="form-select">
      <option nome="ti" disabled selected>Selecione o Curso Prentendido...</option>
      <option nome="ti">Técnico De Informática</option>
      <option nome="ig">Informática de Gestão</option>
      <option nome="grh">Gestão de Recursos Humanos</option>
      <option nome="dp">Desenhador Projectista</option>
      <option nome="te">Técnico de Enfermagem</option>
      <option nome="cfb">Ciências Físicas e Biológicas</option>
      <option nome="ac">Analises Clínicas</option>
      <option nome="farm">Farmácia</option>
    </select>
  </div>
  <div class="col-md-6">
