...
<form class="row g-3">
  ...
  <div class="col-12">
    <label for="idaec" class="form-label">Tipo da AEC</label>
    <select nome="aec" id="idaec" class="form-select">
      <option nome="natacao" selected>Aulas de Natação</option>
