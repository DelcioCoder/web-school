    ...
    <nav class="menu-desktop">
      <div>
        ...
        <li style="margin-right:3%;" class="logo01-desktop"><img width="35px" src="logos/Oxford-University-Circlet.svg.png" width="200px" alt="logo"></li>
          ...
          <li class="listas-desktop"><a style="color: white;" class="links-desktop" href="home.php" target="_top">Home</a></li>
    ...
    <div class="not"><a style="border-radius:5px; padding:10px; position:absolute; margin-left:80%; text-decoration:none; color:white;" href="notificacoes.php" target="_top"><img width="30px" src="icons/comentario-alt.png" alt="notificacao"></a></div>
      ...
      <div class="menu-mobile">
        <ul class="submenu-mobile">
          ...
          <li class="listas-mobile"><a style="color: white;" class="links-mobile" href="home.php" target="_top">Home</a></li>
  ...
  <!-- -------------------CORPO------------------- -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="imagens\book-1822474_1280.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-md-block">
          <h5 style="color:white; text-shadow: black 1px 1px 1px;">Criamos o hábito da leitura ao seu pequeno</h5>
          <p style="color:white; text-shadow: black 1px 1px 1px;">Assim formando adultos com boas condutas</p>
        </div>
      </div>
      <div class="carousel-item">
        <img src="imagens\group-3137670_1280.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-md-block">
          <h5 style="color:white; text-shadow: black 1px 1px 1px;">A alegria de uma criaça vale ouro!</h5>
          <p style="color:white; text-shadow: black 1px 1px 1px;">Aqui o seu pequeno é tratado com amor</p>
        </div>
      </div>
      <div class="carousel-item">
        <img src="imagens\mulher-biblioteca.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-md-block">
          <h5>Nova Biblioteca WebSchool</h5>
          <p>Foi inaugorada a biblioteca da webschool.</p>
        </div>
      </div>
    </div>
...
<div style="padding:30px;" id="carouselExampleCaptions" class="carousel slide">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="imagens\menina-pintada.png" class="d-block w-100" alt="...">
        <div class="carousel-caption d-md-block">
          ...
          <a href="matricula_iniciacao.php"><input class="btn1" type="button" value="Fazer Inscrição"></a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-md-block">
          ...
          <a href="inscricoes_aec.php"><input class="btn1" type="button" value="Fazer Inscrição"></a>
        </div>
      </div>
    </div>
  </div>
